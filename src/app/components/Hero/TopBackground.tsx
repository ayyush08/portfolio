    ...
    return (
        <>
            ...
            <div className="w-full h-full relative">
                ...
                <div className="hidden md:flex  circle-icon md:top-[158px] md:left-[606px]">
                <Image
                    src="/merge_icon.svg"
                    alt="Merge icon"
                    width={23}
            ...
            width={429}
            height={465}
            className='absolute top-[-229px] hidden dark:md:hidden dark:block left-1/2 -translate-x-1/2
            
            '/>
            <div className="absolute top-0 w-full h-[795px] bg-repeat-x bg-[url('/top_bg_dark.svg')] bg-auto hidden md:dark:block" />
            <div className="absolute top-0 w-full h-[600px] bg-repeat-x bg-[url('/top_bg_mobile_dark.svg')] bg-auto hidden dark:block dark:md:hidden  " />
        </>
    )
}
